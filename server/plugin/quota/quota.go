...
func Init() {
	DefaultServiceQuota = config.GetInt("quota.service.limit", defaultServiceLimit, config.WithStandby("QUOTA_SERVICE"))
	DefaultInstanceQuota = config.GetInt("quota.instance.limit", defaultInstanceLimit, config.WithStandby("QUOTA_INSTANCE"))
	DefaultSchemaQuota = config.GetInt("quota.schema.limit", defaultSchemaLimit, config.WithStandby("QUOTA_SCHEMA"))
	DefaultTagQuota = config.GetInt("quota.tag.limit", defaultTagLimit, config.WithStandby("QUOTA_TAG"))
	DefaultRuleQuota = config.GetInt("quota.rule.limit", defaultRuleLimit, config.WithStandby("QUOTA_RULE"))
}
