...
func (*Service) RetrieveProviderPacts(ctx context.Context,
	...
	if err != nil {
		if errors.Is(err, datasource.ErrNoData) {
			PactLogger.Debug(fmt.Sprintf("all provider pact retrieve failed, providerId is %s: provider not exist.", in.ProviderId))
			return &brokerpb.GetAllProviderPactsResponse{
	...
	response := &brokerpb.GetAllProviderPactsResponse{
		Response: pb.CreateResponse(pb.ResponseSuccess, "retrieve provider pact info succeeded."),
		XLinks:   links,
	}
	return response, nil
}
...
func (*Service) RetrieveVerificationResults(ctx context.Context, in *brokerpb.RetrieveVerificationRequest) (*brokerpb.RetrieveVerificationResponse, error) {
	...
	if err != nil {
		if errors.Is(err, datasource.ErrNoData) {
			PactLogger.Debug(fmt.Sprintf("verification result retrieve request failed, consumerID is %s: consumer not exist.", in.ConsumerId))
			return &brokerpb.RetrieveVerificationResponse{
	...
	return &brokerpb.RetrieveVerificationResponse{
		Response: pb.CreateResponse(pb.ResponseSuccess, "Verification result retrieved successfully."),
...
func (*Service) PublishVerificationResults(ctx context.Context, in *brokerpb.PublishVerificationRequest) (*brokerpb.PublishVerificationResponse, error) {
	...
	if err != nil {
		if errors.Is(err, datasource.ErrNoData) {
			PactLogger.Debug(fmt.Sprintf("verification result publish request failed, consumerID is %s: consumer not exist.", in.ConsumerId))
			return &brokerpb.PublishVerificationResponse{
				Response: pb.CreateResponse(pb.ErrInvalidParams, "Consumer does not exist."),
			}, nil
		}
	...
	return &brokerpb.PublishVerificationResponse{
		Response:     pb.CreateResponse(pb.ResponseSuccess, "Verification result published successfully."),
...
func (*Service) PublishPact(ctx context.Context, in *brokerpb.PublishPactRequest) (*brokerpb.PublishPactResponse, error) {
	...
	if err != nil {
		if errors.Is(err, datasource.ErrNoData) {
			PactLogger.Debug(fmt.Sprintf("pact publish failed, providerId is %s: provider not exist.", in.ProviderId))
			return &brokerpb.PublishPactResponse{
				Response: pb.CreateResponse(pb.ErrInvalidParams, "Provider does not exist."),
			}, nil
		}
	...
	if err != nil {
		if errors.Is(err, datasource.ErrNoData) {
			PactLogger.Debug(fmt.Sprintf("pact publish failed, consumerID is %s: consumer not exist.", in.ConsumerId))
			return &brokerpb.PublishPactResponse{
				Response: pb.CreateResponse(pb.ErrInvalidParams, "Consumer does not exist."),
			}, nil
		}
	...
	return &brokerpb.PublishPactResponse{
		Response: pb.CreateResponse(pb.ResponseSuccess, "Pact published successfully."),
	}, nil
}
